    ...
    <form action="{{ route('admin.events.update', $event->id) }}"
        ...
        <div>
            ...
            <input type="text"
                ...
                rounded-2xl focus:ring-4 focus:ring-indigo-500/10
        ...
        <div>
            ...
            <textarea name="description"
                ...
                class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100
                rounded-2xl focus:ring-4 focus:ring-indigo-500/10
                focus:border-indigo-600 outline-none transition font-medium">{{ old('description', $event->description) }}</textarea>
        ...
        <div class="pt-4 flex justify-end gap-4 border-t border-slate-100">
            ...
            <button type="submit"
                class="px-8 py-4 bg-indigo-600 text-white rounded-2xl
                font-bold shadow-lg shadow-indigo-100
